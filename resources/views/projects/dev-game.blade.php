        ...
        <div class="flex flex-wrap items-center">
            ...
            <div class="w-full shrink-0 grow-0 basis-auto lg:w-6/12 xl:w-8/12">
                <div class="px-6 py-12 md:px-12 text-sm">
                    ...
                    <p>With2 the Dev Game Widget, developers can unleash their creativity, improve problem-solving
                        skills, and find a healthy balance between work and play. Whether it's a coding challenge
                        between colleagues or a moment of relaxation during intense coding sessions, the Dev Game Widget
                        aims to make coding more enjoyable and rewarding.</p>
