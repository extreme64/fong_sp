...
@section('description', 'Edit content and projects')
...
<main class="w-full">
    ...
    <nav
        ...
        <ol class="list-reset flex">
            ...
            <li class="text-neutral-500 dark:text-neutral-300">Projects</li>
        </ol>
    </nav>
    <!-- Bread END -->
        ...
        <div class="overflow-x-auto">
            <div class="inline-block min-w-full">
                <div class="overflow-hidden">
                    <table data-ui="projects-list-main" 
                        ...
                        <thead class="border-b font-medium dark:border-neutral-500">
                            <tr class="flex">
                                ...
                                <th scope="col" class="flex-none w-[80px] px-2 py-4">Awards</th>
                        ...
                        <tbody>
                            ...
                            <tr 
                                ...
                                <td class="flex-none w-[40px] px-2 py-4 font-medium">{{ $prj->id }}</td>
                                <td class="flex-1 px-2 py-4">{{ $prj->title }}</td>
                                <td class="flex-none w-[80px] px-2 py-4">{{ $prj->count }}</td>
                                ...
                                <td class="flex-none w-[80px] px-2 py-4">
                                    <div class="flex">
                                        <div
                                            class="mx-1 multi-collapse-{{ $prj->id }} rounded-lg shadow-lg"
                                            ...
                                            <div
                                                ...
                                                <a href="{{ route('dashboard.projects.edit', ['id'=>$prj->id]) }}">
