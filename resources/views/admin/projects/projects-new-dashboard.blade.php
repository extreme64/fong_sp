...
<main data-ui="main-project" class="w-full">
    ...
    <h2 class="mt-9 mb-5 font-bold">
        <div class="flex col-gap-1 items-center">
            ...
            <submit-changes crud-type="<?= ($project->id == false)? 'new' : 'edit' ?>" event-bus-name="eventBusProjectEdit" itemClass="project" itemId="{{ $project->id }}" scopeselector="[data-ui='main-project']" toincludeidentifier="[projectData]" />
        </div>
    </h2>
                                ...
                                <tbody class="flex flex-col">
                                    ...
                                    <tr class="flex justify-between border-b dark:border-neutral-500">
                                        ...
                                        <td class="flex-1 px-2 py-4 overflow-hidden text-ellipsis">
                                            <div class="flex">
                                                <img class="h-6 w-6 mx-2 rounded-md" laoding="lazy" src="{{ asset('storage/images/'.$award->image_path ) }}" alt="award feature image">{{ $award->title }}
                                            </div>
                                        </td>
                                        ...
                                        <td class="flex-none w-[1/5] px-2 py-4">
                                            <div class="flex">
                                                <a href="{{ route('dashboard-award.edit', ['id'=>$award->id]) }}">
                                                ...
                                                <a href="{{ route('dashboard-project.remove-award', ['id'=>$project->id, 'awardId' => $award->id]) }}">
