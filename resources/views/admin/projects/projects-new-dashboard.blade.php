...
<main data-ui="main-project" class="w-full">
    ...
    <h2 class="mt-9 mb-5 font-bold">
        <div class="flex col-gap-1 items-center">
            ...
            <submit-changes 
                apiAction="PATCH"
                apiPoint="{{ route('api.dashboard.project.update', ['id'=>$project->id ]) }}" event-bus-name="eventBusProjectEdit" 
            ...
            <submit-changes 
                apiAction="POST"
                apiPoint="{{ route('api.dashboard.project.create') }}" 
                                    ...
                                    <tr class="flex justify-between border-b dark:border-neutral-500">
                                        ...
                                        <td class="flex-none w-[1/5] px-2 py-4">
                                            <div class="flex">
                                                ...
                                                <!-- <a href="{{ route('api.dashboard.project.remove-award', ['id'=>$project->id, 'awardId' => $award->id]) }}">
