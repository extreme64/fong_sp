...
@section('description', 'Edit content and products')
...
<main class="w-full">
    ...
    <nav
        ...
        <ol class="list-reset flex">
            ...
            <li class="text-neutral-500 dark:text-neutral-300">Products</li>
        </ol>
    </nav>
    <!-- Bread END -->

    <!-- Products table -->
    <h2 class="mt-9 mb-5 font-bold">PRODUCTS</h2>
                ...
                <table 
                    ...
                    <thead class="border-b font-medium dark:border-neutral-500">
                        <tr class="flex">
                            ...
                            <th scope="col" class="flex-none w-[200px] px-2 py-4">Affiliate</th>
                    ...
                    <tr 
                        data-ui="products-list-item-tr-product-{{ $product->id }}" 
                        class="flex border-b dark:border-neutral-500">
                            <td class="flex-none w-[40px] px-2 py-4 font-medium">{{ $product->id }}</td>
                            <td class="flex-1 px-2 py-4 overflow-hidden text-ellipsis">{{ $product->title }}</td>
                            <td class="flex-none w-[200px] px-2 py-4 overflow-hidden text-ellipsis">{{ $product->affiliate_url }}</td>
                            ...
                            <td class="flex-none w-[80px] px-2 py-4">
                                <div class="flex">
                                    <div
                                        class="mx-1 multi-collapse-{{ $product->id }} rounded-lg shadow-lg"
