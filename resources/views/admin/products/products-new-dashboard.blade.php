...
@section('title', 'Product edit - ' . $product?->title )

@section('description', "Edit product's content")


@section('main')
<main data-ui="main-product" class="w-full">
    ...
    <nav
        ...
        <ol class="list-reset flex">
            ...
            <li class="text-neutral-500 dark:text-neutral-300">{{ $product->title }}</li>
        </ol>
    </nav>
    <!-- Bread END -->
    ...
    <h2 class="mt-9 mb-5 font-bold">
        <div class="flex col-gap-1 items-center">
            ...
            <input type="text" name="title" id="title" productData value="{{$product->title}}">
            ...
            <div class="overflow-hidden">
                ...
                <tbody>
                    <tr 
                        ...
                        <td class="flex-none w-[40px] px-2 py-4 font-medium">{{ $product->id }}</td>
                        <td class="flex-1 px-2 py-4">{{ $product->title }}</td>
                        <!-- <td class="flex-none w-[40px] px-2 py-4"> -->
                            <?php
    ...
    <div class="flex flex-col md:flex-row my-8">
                             ...
                             <div class="flex">
                                <div class="flex">
                                    ...
                                    <div
                                        ...
                                        <a href="{{ route('dashboard.files.edit', ['id'=>$fl->id]) }}">
        ...
        <aside class="w-1/1 md:w-1/4 px-4">
            ...
            <textarea
                ...
                productData
                rows="3"
                placeholder="Short info...">{{ $product->description }}</textarea>
            <label
                for="description"
            ...
            <div class="rounded-md border p-1">
                ...
                <div class="relative mb-3" data-te-input-wrapper-init>
                    <input
                        ...
                        name="affiliateLink"
                        productData
                        placeholder="https:/some.link/go/here..."
                ...
                <!-- <input
                    ...
                    productData
                    id="isPublic" 
                    <?= ( (int)$product->status === 1) ? "checked='true'" : ""; ?> 
                    name="isPublic" />
                    <label
